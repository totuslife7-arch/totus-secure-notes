...
For **current v1.2.12** (local-only notes/trips, optional location on device, encrypted voice memos, ads + IAP, on-device Template AI, web vault export, no-API-key maps):
