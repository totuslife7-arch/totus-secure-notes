...
For **current v1.2.16** (local-only notes/trips, optional location on device, encrypted voice memos, system photo picker for attachments, ads + IAP, on-device Template AI, web vault export, no-API-key maps):
