...
**Current version:** 1.2.16 (versionCode 61)  
...
| **Permissions** | ✅ OK | Location (optional GPS mileage), camera (attachments), notifications (reminders). **No `READ_MEDIA_*`** — Android Photo Picker only (v1.2.16) |
