...
- [ ] **Photo and video permissions** — see [`PLAY_PHOTO_PERMISSIONS_DECLARATION.md`](PLAY_PHOTO_PERMISSIONS_DECLARATION.md) (v1.2.16 uses photo picker only; no `READ_MEDIA_*`; versionCode **62**)
