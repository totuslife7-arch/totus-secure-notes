...
**Latest release:** v1.2.16 (versionCode 61) — READ_MEDIA manifest merge fix + Photo Picker compliance. See [RELEASE_NOTES.md](../store/RELEASE_NOTES.md) v1.2.16 section.
