...
| **Secure attachments** | System photo picker (Android) and document picker; secure delete shreds `.enc` files in vault |
...
**Support:** totuslife7@gmail.com (include app version from About & Legal — currently **1.2.16** / Android **62** — device model, OS — never send master password or unencrypted notes).
