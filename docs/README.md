...
| [../store/RELEASE_NOTES.md](../store/RELEASE_NOTES.md) | Release notes / What's New (v1.2.11) |
...
**Current version:** 1.2.11 · Android versionCode 40 · `com.totuslife.TotusSecureNotes`  
